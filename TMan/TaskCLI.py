...
@click.option('-sd', type=str, callback=TManLibrary.check_date,
              help='Начало')
@click.option('-ed', type=str, callback=TManLibrary.check_date,
              help='Конец')
...
@click.option('-ti', type=str,
              help='Название')
@click.option('-re', type=str, callback=TManLibrary.check_time,
              help='Название')
