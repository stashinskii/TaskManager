...
class SchedulerForm(forms.ModelForm):
    ...
    tag = forms.CharField(label='Info',
                          widget=forms.TextInput(attrs={'size': 20,
                                                        'maxlength': 200,
                                                        'placeholder': 'Input tag'}))

    last_added = forms.DateTimeField(widget=HiddenInput(), required=False)

    subscribers = forms.MultipleChoiceField(widget=HiddenInput(), required=False)
...
class TaskForm(forms.ModelForm):
    ...
    title = forms.CharField(widget=forms.TextInput(attrs={'size': 20,
                                                          ...
                                                          'placeholder':
                                                              'Input title'}))
    description = forms.CharField(label='Info', widget=forms.TextInput(
        attrs={'size': 20,
               'maxlength': 200,
               'placeholder':
                   'Input description'}))
